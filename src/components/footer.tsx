        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8 mb-8">
          ...
          <div>
            ...
            <p className="text-slate-600 dark:text-slate-400 text-sm">
              Full Stack Developer crafting digital experiences and scalable applications.
            </p>
          </div>

          {/* Quick Links */}
          <div>
            <h4 className="font-semibold text-sm mb-4 text-slate-900 dark:text-white uppercase tracking-wide">
              Quick Links
            </h4>
