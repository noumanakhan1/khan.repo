    ...
    <>
      ...
      <section className="relative min-h-screen flex flex-col lg:flex-row overflow-hidden">
        ...
        <div className="absolute inset-0 -z-10">
          ...
          <div className="absolute bottom-20 left-1/4 w-72 h-72 bg-pink-300 rounded-full mix-blend-multiply filter blur-3xl opacity-20 dark:opacity-10 animate-blob animation-delay-4000"></div>
        </div>
        ...
        <div className="flex-1 flex items-center">
          <Container>
            ...
            >
              ...
              <motion.h1
                variants={itemVariants}
                className="text-4xl sm:text-5xl lg:text-6xl font-bold mb-6 bg-gradient-to-r from-blue-600 via-purple-600 to-pink-600 dark:from-blue-400 dark:via-purple-400 dark:to-pink-400 bg-clip-text text-transparent leading-tight text-center lg:text-left"
              >
              ...
              <motion.p
                variants={itemVariants}
                className="text-lg sm:text-xl text-slate-600 dark:text-slate-400 mb-8 leading-relaxed text-center lg:text-left"
              >
              ...
              <motion.div variants={itemVariants} className="flex gap-4 justify-center lg:justify-start">
                <a
                  ...
                  className="p-3 rounded-full bg-slate-100 dark:bg-slate-800 text-slate-700 dark:text-slate-300 hover:bg-blue-100 dark:hover:bg-blue-900/30 hover:text-blue-600 transition-all duration-300"
                >
        ...
        <Container>
          ...
          >
            <h2 className="text-4xl md:text-6xl font-extrabold tracking-tight text-slate-900 dark:text-white leading-tight">
              I build things <br />
              <span className="text-blue-600 dark:text-blue-500">founders actually</span> <br />
              ship and sell.
            </h2>
          </motion.div>
        </Container>
        ...
        <Container>
          <div className="max-w-4xl mx-auto">
            <motion.div
              ...
              transition={{ duration: 0.6 }}
              viewport={{ once: true }}
              className="bg-white dark:bg-slate-900 rounded-3xl p-8 md:p-12 border border-slate-200 dark:border-slate-800 shadow-xl shadow-slate-200/20 dark:shadow-none"
            >
              <h2 className="text-3xl font-bold mb-4">Watch before you book</h2>
              <p className="text-xl text-slate-600 dark:text-slate-400 mb-8 font-medium">How I think about building products.</p>

              <div className="bg-slate-100 dark:bg-slate-800/60 rounded-2xl p-6 mb-8 border border-slate-200 dark:border-slate-700">
                <p className="text-slate-700 dark:text-slate-300 mb-4 font-medium">A 90-second breakdown of how I approach MVPs, what kills most product builds before they ship, and what I do differently.</p>
        ...
        <Container>
          <div className="max-w-4xl mx-auto">
            ...
            <motion.div
              ...
              viewport={{ once: true }}
              className="bg-slate-50 dark:bg-slate-800/50 rounded-3xl p-8 md:p-12 border border-slate-200 dark:border-slate-700"
            >
              ...
              <div className="pt-8 border-t border-slate-200 dark:border-slate-700">
                <p className="text-xl font-bold text-slate-900 dark:text-white">From $12,000 <span className="text-slate-400 font-normal">· Delivered in 4 to 8 weeks</span></p>
              </div>
            </motion.div>
          </div>
        </Container>
        ...
        <Container>
          ...
          <div className="grid md:grid-cols-2 gap-8 max-w-5xl mx-auto">
            <motion.div
              ...
              viewport={{ once: true }}
              className="bg-white dark:bg-slate-900 p-10 rounded-3xl border border-slate-200 dark:border-slate-800 shadow-sm"
            >
              <div className="text-5xl font-extrabold text-slate-100 dark:text-slate-800 mb-6">01</div>
            ...
            <motion.div
              ...
              className="bg-white dark:bg-slate-900 p-10 rounded-3xl border border-slate-200 dark:border-slate-800 shadow-sm"
            >
              <div className="text-5xl font-extrabold text-slate-100 dark:text-slate-800 mb-6">02</div>
      ...
      <section className="py-24 bg-white dark:bg-slate-900">
        <Container>
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-6 max-w-6xl mx-auto">
            {[
              ...
              <motion.div
                ...
                viewport={{ once: true }}
                className="flex flex-col bg-slate-50 dark:bg-slate-800/50 p-8 rounded-3xl border border-slate-200 dark:border-slate-700"
              >
                <div className="text-blue-600 dark:text-blue-500 font-bold text-xl mb-4">{step.num}</div>
          ...
          <div className="mt-16 text-center">
            <Link
              href="/contact"
              className="inline-block px-8 py-4 bg-slate-900 dark:bg-white text-white dark:text-slate-900 rounded-full font-bold text-lg hover:scale-105 transition-transform"
            >
