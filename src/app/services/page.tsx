...
export default function Services() {
  return (
    <>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
            {services.map((service, index) => (
              <motion.div
                ...
                viewport={{ once: true }}
                className="group p-8 rounded-xl border border-slate-800 bg-slate-900 hover:border-purple-500 hover:shadow-lg transition-all duration-300"
              >
      ...
      {/* Tech Stack Section */}
      <section className="py-20 bg-gradient-to-r from-slate-900/50 to-slate-900/50">
        <Container>
              ...
              >
                ...
                <ul className="space-y-2">
                  {stack.techs.map((tech) => (
                    <li key={tech} className="text-sm text-slate-400 flex items-center gap-2">
